...
interface DutaPostFormProps {
  onClose: () => void; 
}

const DutaPostForm: React.FC<DutaPostFormProps> = ({ onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <h2 className="text-2xl font-bold text-bluetiful">Unggah Kegiatan Duta Pelajar</h2>
      <input
        type="text"
