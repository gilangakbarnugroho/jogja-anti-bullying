...
import PostCardDuta from "../../../../components/PostCardDuta";
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex items-center space-x-1 text-gray-500">
            < FaUserGraduate />
          <p className="text-gray-500">Manage Duta Pelajar</p>
          </div>
        ...
        <div className="flex justify-center items-center mb-6">
          <button
            className={`px-4 py-2 rounded ${
              selectedFilter === "approved" ? "bg-bluetiful text-white" : "bg-gray-200 text-gray-700"
            }`}
          ...
          <button
            className={`px-4 py-2 rounded ${
              selectedFilter === "unapproved" ? "bg-bluetiful text-white" : "bg-gray-200 text-gray-700"
            }`}
